...
function loadModelToApp(app) {
    ...
    const delegate = mongooseConfig.delegate||'model';    // mongo model app 属性名配置
    const baseDir =  mongooseConfig.baseDir|| 'model'   // mongodb model 目录配置
    const dir = path.join(app.baseDir, baseDir);
